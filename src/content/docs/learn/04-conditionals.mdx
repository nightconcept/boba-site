...
Boba also provides a powerful `match` statement for checking a variable against a series of possible values. It's a clean way to handle multiple distinct cases.
